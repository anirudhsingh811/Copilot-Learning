...
// What's the difference b/w storing value in azure key vault vs in Environment setting and configuration setting of Azure web app ?
// Storing sensitive values like connection strings, API keys, and secrets in Azure Key Vault provides enhanced security through features like access policies, auditing, and versioning.
// Environment settings and configuration settings in Azure Web Apps are less secure as they can be more easily accessed or exposed.
// Key Vault also allows for centralized management of secrets across multiple applications.

// Logging from how many ways ?
// 1. Console Logging   
// 2. Debug Logging
// 3. Event Source Logging
//  4. Application Insights Logging
// / 5. Third-party logging providers (e.g., Serilog, NLog)
//
