...
namespace AzureAppServiceExamples
{
    ...
    public class AppServiceManager
    {
            ...
            string location = "eastus")
        {
            ...
            var webSiteData = new WebSiteData(location)
            {
                ...
                SiteConfig = new SiteConfigProperties
                {
                    ...
                    AlwaysOn = true,
                    Http20Enabled = true,
                    MinTlsVersion = SupportedTlsVersion.Tls12,
                    HttpsOnly = true
                }
            };
            ...
            string webAppName)
        {
            ...
            var configData = new SiteConfigData(webApp.Value.Data.Location)
            {
            ...
            int capacity = 2)
        {
            ...
            updateData.Sku = new AppServiceSkuDescription
            {
                Name = skuName,
                Capacity = capacity
            };
            ...
            string targetSlot = "production")
        {
            ...
            {
                await webApp.Value.SwapSlotAsync(Azure.WaitUntil.Completed, swapParameters);
            }
            else
            {
                var slot = await webApp.Value.GetWebSiteSlots().GetAsync(sourceSlot);
                await slot.Value.SwapSlotSlotAsync(Azure.WaitUntil.Completed, swapParameters);
            }
            ...
            string webAppName)
        {
            ...
            var updateData = webApp.Value.Data;
            updateData.Identity = new Azure.ResourceManager.Models.ManagedServiceIdentity(
                Azure.ResourceManager.Models.ManagedServiceIdentityType.SystemAssigned
            );

            await webApp.Value.UpdateAsync(updateData);
