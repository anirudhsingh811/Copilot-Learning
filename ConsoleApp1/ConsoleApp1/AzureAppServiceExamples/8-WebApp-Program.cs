...
namespace AzureAppServiceExamples
{
    public class ProgramExample
    {
        ...
        public static async Task MainRunAsync(string[] args)
        {
            ...
            Console.WriteLine();
            Console.WriteLine("⚠️  WARNING: Running this will create REAL Azure resources!");
            Console.WriteLine("   This may incur costs in your Azure subscription.");
            Console.WriteLine();
            ...
            {
                Console.WriteLine();
                Console.WriteLine("❌ Operation cancelled. No resources were created.");
                Console.WriteLine();
                Console.WriteLine("💡 TIP: Update your subscription ID and resource group name");
                Console.WriteLine("   in the code before running actual Azure operations.");
                return;
            }
